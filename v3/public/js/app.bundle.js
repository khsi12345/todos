...
(function () {
  ...
  var allchecked = document.querySelector('#chk-allComplete');
  var tabList = document.querySelector('.nav');
  var selectTab = document.querySelectorAll('.nav li');
  var completedCount = document.querySelector('#completedTodos');
  var status = 'all';
  ...
  function checkedCount() {
    completedCount.textContent = todos.filter(function (todo) {
  ...
  function isCompletedChecked() {
    return todos.length ? todos.length === todos.filter(function (_ref) {
  ...
  function todoAdd() {
    ...
    _axios2.default.post('/todos', { id: maxId(), content: todoInput.value, completed: false })
    // 서버 응답이 완료되면(응답 상태가 201) 실행 될 함수.
    .then(function () {
      // /todos에 요청을 보낸다.
      _axios2.default.get('/todos')
  ...
  list.addEventListener('change', function (e) {
    ...
    if (e.target.nodeName === 'INPUT') {
      _axios2.default.patch('/todos/' + e.target.id, { completed: e.target.checked }).then(function () {
        _axios2.default.get('/todos').then(function (_ref3) {
          var data = _ref3.data;
  ...
  list.addEventListener('click', function (e) {
    ...
    _axios2.default.delete('/todos/' + e.target.dataset.id).then(function () {
      // console.dir(data);
  ...
  allchecked.addEventListener('change', function (e) {
    console.dir(e.target);
    _axios2.default.patch('/todos', { completed: e.target.checked }).then(function () {
      _axios2.default.get('/todos').then(function (_ref5) {
        var data = _ref5.data;
  ...
  tabList.addEventListener('click', function (e) {
    selectTab.forEach(function (select) {
  ...
  document.querySelector('#btn-removeCompletedTodos').addEventListener('click', function () {
    _axios2.default.delete('/todos/completed').then(function () {
      _axios2.default.get('/todos').then(function (_ref6) {
        var data = _ref6.data;
  ...
  window.addEventListener('load', function () {
    _axios2.default.get('/todos').then(function (_ref7) {
      var data = _ref7.data;
